  ...
  return (
    <div className="bg-white dark:bg-slate-900 shadow-2xl rounded-3xl overflow-hidden border">
      <div className="p-8">
        ...
        <h2 className="text-2xl font-bold text-center text-slate-900 dark:text-white mb-2">¿Olvidaste tu contraseña?</h2>
        <p className="text-slate-500 dark:text-slate-400 text-center text-sm mb-8">No te preocupes, dinos tu correo y te enviaremos un enlace de recuperación</p>
        ...
        <div className="mt-8 pt-6 border-t text-center">
          <Link href="/login" className="inline-flex items-center text-sm text-blue-600 hover:text-blue-700 font-bold gap-2">
